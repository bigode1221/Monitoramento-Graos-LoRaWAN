...
void HAL_UART_MspInit(UART_HandleTypeDef* huart)
{
  ...
  */
  ...
  /* USER CODE END USART1_MspInit 0 */
    ...
    /** Configura a fonte de clock do USART1 para PCLK2 (48 MHz) */
    ...
    /* Habilita o clock do GPIOB (PB6 e PB7) */
    __HAL_RCC_GPIOB_CLK_ENABLE();

    /**USART1 GPIO Configuration
    PB6  -------> USART1_TX  (conect. ao sensor Pin 5 / RXD)
    PB7  -------> USART1_RX  (conect. ao sensor Pin 6 / TXD)
    */
    GPIO_InitTypeDef GPIO_InitStruct = {0};
    ...
    /* PB7: USART1_RX com Pull-Up interno para evitar ruído flutuante */
...
void HAL_UART_MspDeInit(UART_HandleTypeDef* huart)
{
  ...
  /* USER CODE END USART1_MspDeInit 0 */
    /* Desabilita o clock do USART1 */
    __HAL_RCC_USART1_CLK_DISABLE();

    /**USART1 GPIO Deconfiguration
    PB6  -------> USART1_TX
    PB7  -------> USART1_RX
    */
